...
`define AUTOTB_TVIN_inStream_V_data_V  "./c.doGain.autotvin_inStream_V_data_V.dat"
`define AUTOTB_TVIN_inStream_V_keep_V  "./c.doGain.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V  "./c.doGain.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V  "./c.doGain.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V  "./c.doGain.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V  "./c.doGain.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V  "./c.doGain.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data_V  "./c.doGain.autotvin_outStream_V_data_V.dat"
`define AUTOTB_TVIN_outStream_V_keep_V  "./c.doGain.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V  "./c.doGain.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V  "./c.doGain.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V  "./c.doGain.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V  "./c.doGain.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V  "./c.doGain.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_gain  "./c.doGain.autotvin_gain.dat"
`define AUTOTB_TVIN_inStream_V_data_V_out_wrapc  "./rtl.doGain.autotvin_inStream_V_data_V.dat"
`define AUTOTB_TVIN_inStream_V_keep_V_out_wrapc  "./rtl.doGain.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V_out_wrapc  "./rtl.doGain.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V_out_wrapc  "./rtl.doGain.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V_out_wrapc  "./rtl.doGain.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V_out_wrapc  "./rtl.doGain.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V_out_wrapc  "./rtl.doGain.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data_V_out_wrapc  "./rtl.doGain.autotvin_outStream_V_data_V.dat"
`define AUTOTB_TVIN_outStream_V_keep_V_out_wrapc  "./rtl.doGain.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V_out_wrapc  "./rtl.doGain.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V_out_wrapc  "./rtl.doGain.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V_out_wrapc  "./rtl.doGain.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V_out_wrapc  "./rtl.doGain.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V_out_wrapc  "./rtl.doGain.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_gain_out_wrapc  "./rtl.doGain.autotvin_gain.dat"
`define AUTOTB_TVOUT_outStream_V_data_V  "./c.doGain.autotvout_outStream_V_data_V.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V  "./c.doGain.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V  "./c.doGain.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V  "./c.doGain.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V  "./c.doGain.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V  "./c.doGain.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V  "./c.doGain.autotvout_outStream_V_dest_V.dat"
`define AUTOTB_TVOUT_outStream_V_data_V_out_wrapc  "./impl_rtl.doGain.autotvout_outStream_V_data_V.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V_out_wrapc  "./impl_rtl.doGain.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V_out_wrapc  "./impl_rtl.doGain.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V_out_wrapc  "./impl_rtl.doGain.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V_out_wrapc  "./impl_rtl.doGain.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V_out_wrapc  "./impl_rtl.doGain.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V_out_wrapc  "./impl_rtl.doGain.autotvout_outStream_V_dest_V.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.doGain.autotvout_outStream_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doGain.autotvout_outStream_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doGain.autotvout_outStream_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doGain.autotvout_outStream_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.doGain.autotvout_outStream_V_data_V.dat with impl_rtl.doGain.autotvout_outStream_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.doGain.autotvout_outStream_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doGain.autotvout_outStream_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doGain.autotvout_outStream_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doGain.autotvout_outStream_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.doGain.autotvout_outStream_V_keep_V.dat with impl_rtl.doGain.autotvout_outStream_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.doGain.autotvout_outStream_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doGain.autotvout_outStream_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doGain.autotvout_outStream_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doGain.autotvout_outStream_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.doGain.autotvout_outStream_V_strb_V.dat with impl_rtl.doGain.autotvout_outStream_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.doGain.autotvout_outStream_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doGain.autotvout_outStream_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doGain.autotvout_outStream_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doGain.autotvout_outStream_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.doGain.autotvout_outStream_V_user_V.dat with impl_rtl.doGain.autotvout_outStream_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.doGain.autotvout_outStream_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doGain.autotvout_outStream_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doGain.autotvout_outStream_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doGain.autotvout_outStream_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.doGain.autotvout_outStream_V_last_V.dat with impl_rtl.doGain.autotvout_outStream_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.doGain.autotvout_outStream_V_id_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doGain.autotvout_outStream_V_id_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doGain.autotvout_outStream_V_id_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doGain.autotvout_outStream_V_id_V.dat\"!");
    else begin
        $display("Comparing rtl.doGain.autotvout_outStream_V_id_V.dat with impl_rtl.doGain.autotvout_outStream_V_id_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.doGain.autotvout_outStream_V_dest_V.dat", "r");
    fp2 = $fopen("./impl_rtl.doGain.autotvout_outStream_V_dest_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.doGain.autotvout_outStream_V_dest_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.doGain.autotvout_outStream_V_dest_V.dat\"!");
    else begin
        $display("Comparing rtl.doGain.autotvout_outStream_V_dest_V.dat with impl_rtl.doGain.autotvout_outStream_V_dest_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
