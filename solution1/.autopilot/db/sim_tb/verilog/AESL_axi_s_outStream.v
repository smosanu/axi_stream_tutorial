...
`define TV_OUT_outStream_TDATA "./impl_rtl.doGain.autotvout_outStream_V_data_V.dat"
`define EGRESS_STATUS_outStream_TDATA "./stream_egress_status_outStream_V_data_V.dat"
`define TV_OUT_outStream_TKEEP "./impl_rtl.doGain.autotvout_outStream_V_keep_V.dat"
`define EGRESS_STATUS_outStream_TKEEP "./stream_egress_status_outStream_V_keep_V.dat"
`define TV_OUT_outStream_TSTRB "./impl_rtl.doGain.autotvout_outStream_V_strb_V.dat"
`define EGRESS_STATUS_outStream_TSTRB "./stream_egress_status_outStream_V_strb_V.dat"
`define TV_OUT_outStream_TUSER "./impl_rtl.doGain.autotvout_outStream_V_user_V.dat"
`define EGRESS_STATUS_outStream_TUSER "./stream_egress_status_outStream_V_user_V.dat"
`define TV_OUT_outStream_TLAST "./impl_rtl.doGain.autotvout_outStream_V_last_V.dat"
`define EGRESS_STATUS_outStream_TLAST "./stream_egress_status_outStream_V_last_V.dat"
`define TV_OUT_outStream_TID "./impl_rtl.doGain.autotvout_outStream_V_id_V.dat"
`define EGRESS_STATUS_outStream_TID "./stream_egress_status_outStream_V_id_V.dat"
`define TV_OUT_outStream_TDEST "./impl_rtl.doGain.autotvout_outStream_V_dest_V.dat"
