...
`define INGRESS_STATUS_inStream_TDATA "./stream_ingress_status_inStream_V_data_V.dat"
`define TV_IN_inStream_TKEEP "./c.doGain.autotvin_inStream_V_keep_V.dat"
`define INGRESS_STATUS_inStream_TKEEP "./stream_ingress_status_inStream_V_keep_V.dat"
`define TV_IN_inStream_TSTRB "./c.doGain.autotvin_inStream_V_strb_V.dat"
`define INGRESS_STATUS_inStream_TSTRB "./stream_ingress_status_inStream_V_strb_V.dat"
`define TV_IN_inStream_TUSER "./c.doGain.autotvin_inStream_V_user_V.dat"
`define INGRESS_STATUS_inStream_TUSER "./stream_ingress_status_inStream_V_user_V.dat"
`define TV_IN_inStream_TLAST "./c.doGain.autotvin_inStream_V_last_V.dat"
`define INGRESS_STATUS_inStream_TLAST "./stream_ingress_status_inStream_V_last_V.dat"
`define TV_IN_inStream_TID "./c.doGain.autotvin_inStream_V_id_V.dat"
`define INGRESS_STATUS_inStream_TID "./stream_ingress_status_inStream_V_id_V.dat"
`define TV_IN_inStream_TDEST "./c.doGain.autotvin_inStream_V_dest_V.dat"
`define INGRESS_STATUS_inStream_TDEST "./stream_ingress_status_inStream_V_dest_V.dat"
